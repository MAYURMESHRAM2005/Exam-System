...
/* =========================
   DELETE EXAM
   Ownership check is done inside the controller itself, so only the
   creating instructor can delete — a route-level instructorOnly gate
   here would be redundant with that ownership check.
========================= */
